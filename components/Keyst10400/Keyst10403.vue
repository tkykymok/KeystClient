<template>
  <div class="w-full h-full p-6 flex justify-center items-center z-10 fixed top-0 left-0 bg-black bg-opacity-50" @click="$emit('closeModal')">
    <div class="w-1/2 py-12 bg-white">
