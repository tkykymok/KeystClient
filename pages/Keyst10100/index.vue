  ...
  <div class='p-4'>
    ...
    <table class="w-9/12 mx-auto text-left min-w-full text-xs">
      <tr class="">
        ...
        <td class="p-2">
<!--          <button @click="postalCodeBtn">aa</button>-->
        </td>
      </tr>
      <tr class="">
        ...
        <td class="p-2">
<!--          <button @click="nameKanaBtn">aa</button>-->
        </td>
        ...
        <td class="p-2">
<!--          <button @click="addressBtn">aa</button>-->
        </td>
      </tr>
      <tr class="">
        ...
        <td class="p-2">
<!--          <button @click="mailBtn">aa</button>-->
        </td>
        ...
        <td class="p-2">
<!--          <button @click="phoneNumberBtn">aa</button>-->
        </td>
      </tr>
      <tr class="">
        ...
        <td class="p-2">
<!--          <button @click="loginIdBtn">aa</button>-->
        </td>
        ...
        <td class="p-2">
<!--          <button @click="bankNameBtn">aa</button>-->
        </td>
      </tr>
      <tr class="">
        ...
        <td class="p-2">
<!--          <button @click="loginPwBtn">aa</button>-->
        </td>
        ...
        <td class="p-2">
<!--          <button @click="branchNameBtn">aa</button>-->
        </td>
      </tr>
      <tr class="">
...
<!--          <button @click="prfImgStrgDrctryBtn">aa</button>-->
        ...
        <td class="p-2">
<!--          <button @click="branchIdBtn">aa</button>-->
        </td>
      </tr>
      <tr class="">
        ...
        <td class="p-2">
<!--          <button @click="accountTypeBtn">aa</button>-->
        </td>
      </tr>
      <tr class="">
        ...
        <td class="p-2">
<!--          <button @click="accountNumberBtn">aa</button>-->
        </td>
      </tr>
      <tr class="">
        ...
        <td class="p-2">
<!--          <button @click="accountNameBtn">aa</button>-->
        </td>
      </tr>
      <tr class="">
...
<!--          <button @click="birthdayBtn">aa</button>-->
        </td>
      </tr>
      <tr class="">
        ...
        <td colspan="5" class="p-2">
<!--          <button @click="nationalityBtn">aa</button>-->
        </td>
      </tr>
      <tr class="">
      ...
      <tr class="">
        ...
        <td colspan="5" class="p-2">
<!--          <button @click="nearestStationBtn">aa</button>-->
        </td>
      </tr>
      <tr class="">
        ...
        <td colspan="5" class="p-2">
<!--          <button @click="finalEducationDateBtn">aa</button>-->
        </td>
      </tr>
      <tr class="">
        ...
        <td colspan="5" class="p-2">
<!--          <button @click="finalEducationContentBtn">aa</button>-->
        </td>
      </tr>
      <tr class="">
        ...
        <td colspan="5" class="p-2">
<!--          <button @click="skillsBtn">aa</button>-->
        </td>
      </tr>
    </table>
